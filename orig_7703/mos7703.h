...
static int  mos7703_write			(struct usb_serial_port *port, const unsigned char *buf, int count);
...
static int  send_cmd_write_baud_rate	(struct moschip_port *mos7703_port, int baudRate);

 ...
 ************************************************************************/
	...
	// Numbers 0-7 are passed to the mos7703 directly. Numbers 8 and
	// above are used internally to indicate that we must enable access
	// to them via LCR bit 0x80 or LCR = 0xBF.
	// The register number sent to the mos7703 is then (x & 0x7).
	//
...
#define MOS7703_MSR_DELTA_CTS		0x01	// CTS changed from last read
#define MOS7703_MSR_DELTA_DSR		0x02	// DSR changed from last read
#define MOS7703_MSR_DELTA_RI		0x04	// RI  changed from 0 -> 1
#define MOS7703_MSR_DELTA_CD		0x08	// CD  changed from last read
